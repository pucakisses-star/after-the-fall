...
export const TOOLS: ToolDef[] = [
  { id: 'select', label: 'Select', key: 'V', icon: <IconCursor />, hint: 'Click to select. Shift-drag to box-select. Drag cities and labels. Double-click a reference city to make it yours and rename it.' },
  ...
  { id: 'settlement', label: 'Settlement', key: 'S', icon: <IconSettlement />, hint: 'Click to place a city, capital or fortress — or click one of the reference cities to make it yours and rename it.' },
