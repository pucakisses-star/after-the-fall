...
const STARTING_POINTS: { id: string; label: string; description: string; basemaps: string[]; center: [number, number]; zoom: number }[] = [
  ...
  },
  {
    ...
    description: 'Natural Earth land outlines as a tracing reference.',
    basemaps: ['world-land-50m'],
    center: [0, 20],
    zoom: 2.4,
  },
  {
    ...
    description: 'Land plus modern country boundaries, ready to convert.',
    basemaps: ['world-land-50m', 'world-countries-50m'],
    center: [0, 20],
    zoom: 2.4,
  },
  {
  ...
  },
  {
    ...
    description: '3,000+ counties. Use the paint tool to build states from them.',
    basemaps: ['us-states', 'us-counties'],
    center: [-96, 39],
    zoom: 4.2,
  },
];
