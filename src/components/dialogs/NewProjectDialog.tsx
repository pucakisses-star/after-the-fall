...
const STARTING_POINTS: { id: string; label: string; description: string; basemaps: string[]; center: [number, number]; zoom: number }[] = [
  ...
  },
  {
    ...
    description: 'Natural Earth land outlines and lakes as a tracing reference.',
    basemaps: ['world-land-50m', 'world-lakes-50m'],
    center: [0, 20],
    zoom: 2.4,
  },
  {
    ...
    description: 'Land, lakes and modern country boundaries, ready to convert.',
    basemaps: ['world-land-50m', 'world-lakes-50m', 'world-countries-50m'],
    center: [0, 20],
    zoom: 2.4,
  },
  {
    ...
    description:
      'Natural Earth at its finest published scale: coastlines, lakes and rivers, ~7× the detail of 1:50m. Around 10 MB, so use it when mapping a region rather than the globe.',
    basemaps: ['world-land-10m', 'world-lakes-10m', 'world-rivers-10m', 'world-countries-10m'],
    center: [0, 20],
    zoom: 2.4,
  },
  {
    ...
    description: 'State outlines with lakes and rivers, ideal for alternate-history North America.',
    basemaps: ['us-states', 'world-lakes-10m', 'world-rivers-10m'],
    center: [-96, 39],
    zoom: 4.2,
  },
  {
    ...
    description: '3,000+ counties, with lakes and rivers. Use the paint tool to build states from them.',
    basemaps: ['us-states', 'us-counties', 'world-lakes-10m', 'world-rivers-10m'],
    center: [-96, 39],
    zoom: 4.2,
  },
];
